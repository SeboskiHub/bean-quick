                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: 2px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025); margin: 0 auto; width: 570px;">
                                <tr>
                                    <td class="content-cell" style="padding: 32px;">
                                        <h1 style="color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">¡Bienvenido a BeanQuick!</h1>
                                        ...
                                        <p style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Tu cuenta ha sido creada exitosamente en <strong>BeanQuick</strong>. Nos alegra tenerte con nosotros.
                                        </p>

                                        <p style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            A partir de ahora podrás genestionar reservas en tus cafeterias favoritas de forma rápida y sencilla desde nuestra plataforma. Si tienes alguna duda o necesitas ayuda, no dudes en contactarnos.
                                        </p>
